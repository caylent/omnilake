...
from omnilake.client.commands.create_source_type import CreateSourceTypeCommand

__all__ = {k.command_name: k for k in [ChainCommand, RefreshIndexCommand, QuestionCommand, CreateSourceTypeCommand]}