...
class CompactionJob(TableObject):
    table_name = 'compaction_jobs'

    description = 'Table tracking all compaction jobs'
    ...
    ttl_attribute = TableObjectAttribute(
        ...
        description="The time to live for the compaction job context.",
    ...
    attributes = [
        TableObjectAttribute(
            name="created_on",
            attribute_type=TableObjectAttributeType.DATETIME,
            description="The date and time the compaction job context was created.",
        ...
        TableObjectAttribute(
            ...
            description="The current run of the compaction job context.",
            default=0,
        ),
        ...
        TableObjectAttribute(
            ...
            description="The names of the resources that have been completed in the current run of the compaction job context.",
            optional=True,
        ),
        ...
        TableObjectAttribute(
            ...
            attribute_type=TableObjectAttributeType.STRING_SET,
            description="The names of the resources generated by the compaction job context.",
            optional=True,
        ),
        ...
        TableObjectAttribute(
            name="parent_job_id",
            attribute_type=TableObjectAttributeType.STRING,
            description="The parent job ID of the compaction job context.",
            optional=True,
        ),
        ...
        TableObjectAttribute(
            ...
            attribute_type=TableObjectAttributeType.STRING,
            description="The parent job type of the compaction job context.",
            optional=True,
        ),
        ...
        TableObjectAttribute(
            ...
            attribute_type=TableObjectAttributeType.NUMBER,
            description="The number of remaining processes being executed for the compaction job context.",
            default=0,
            optional=True,
        ),
    ]
...
class CompactionJobsTableClient(TableClient):
    def __init__(self, app_name: Optional[str] = None, deployment_id: Optional[str] = None):
        super().__init__(
            app_name=app_name,
            default_object_class=CompactionJob,
    ...
    def get(self, request_id: str, consistent_read: Optional[bool] = False) -> Union[CompactionJob, None]:
        """
        Get a compaction job context by request ID.
    ...
    def put(self, context: CompactionJob) -> None:
        """
        Puts a compaction job context
