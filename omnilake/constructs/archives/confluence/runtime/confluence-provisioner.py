"""
Confluence Archive Provisioner

This function is responsible for creating a new confluence archive
"""
import logging
...
@fn_event_response(exception_reporter=ExceptionReporter(), function_name='confluence_archive_provisioner',
                   logger=Logger('omnilake.storage.confluence.provisioner'))
def handler(event: Dict, context: Dict) -> Dict:
    ...
    space_key = configuration.get("space_key")
